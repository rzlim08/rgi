            ...
            for blast_record in blast_records:
                ...
                for alignment in blast_record.alignments:
                    ...
                    if modelTypeID == 41091:
                        ...
                        seqinModel = modelDescrpt[
                            underscoreinMD + 1 : modelDescrpt.index(" ")
                        ]
                        ...
                        for hsp in alignment.hsps:
                            ...
                            try:
                                card_sequence = str(
                                    json_data[modelID]["model_sequences"]["sequence"][
                                        seqinModel
                            ...
                            if predicted_genes_dict:
                                if orfInfo.strip() in predicted_genes_dict.keys():
                                    orf_protein_sequence = str(
                                        Seq(
                                            predicted_genes_dict[orfInfo.decode()]
                                        ).translate(table=11)
                                    ).strip("*")
                                else:
                                    orf_protein_sequence = str(
                            ...
                            try:
                                if (
                                    ...
                                    ppinsidedict["model_name"] = json_data[modelID][
                                        "model_name"
                                    ]
                                    ppinsidedict["model_type"] = json_data[modelID][
                                        "model_type"
                                    ]
                                    ppinsidedict["model_type_id"] = modelTypeID
                                    ppinsidedict["pass_evalue"] = pass_evalue
                                    ppinsidedict["pass_bitscore"] = pass_bitscore
                                    ppinsidedict["ARO_accession"] = json_data[modelID][
                                        "ARO_accession"
                                    ]
                                    ppinsidedict["ARO_name"] = json_data[modelID][
                                        "ARO_name"
                                    ]
                                    ppinsidedict["ARO_category"] = json_data[modelID][
                                        "ARO_category"
                                    ]
                                    ppinsidedict["evalue"] = hsp.expect
                                    ppinsidedict["bit_score"] = hsp.bits
                                    ppinsidedict["max_identities"] = hsp.identities
                                    ppinsidedict["cvterm_id"] = json_data[modelID][
                                        "model_sequences"
                                    ]["sequence"][seqinModel]["NCBI_taxonomy"][
                                    ...
                                    ] = json_data[modelID]["model_sequences"][
                                        "sequence"
                                    ][
                                        seqinModel
                                    ][
                                    ...
                                    if (
                                        "partial"
                                        in json_data[modelID]["model_sequences"][
                                            "sequence"
                                        ][seqinModel]["dna_sequence"].keys()
                                    ):
                                        ppinsidedict["partial"] = json_data[modelID][
                                            "model_sequences"
                                        ]["sequence"][seqinModel]["dna_sequence"][
                                            "partial"
                                        ]
                                    else:
                                    ...
                                    if self.input_type == "contig":
                                        ppinsidedict["query_start"] = (
                                            self.extract_nth_hash(orfInfo.decode(), 1)
                                            + (hsp.query_start - 1) * 3
                                        )
                                        ppinsidedict["query_end"] = (
                                            self.extract_nth_hash(orfInfo.decode(), 1)
                                            + (hsp.query_start - 1) * 3
                                            + realQueryLength * 3
                                            - 1
                                        ...
                                        ppinsidedict[
                                            "orf_strand"
                                        ] = self.extract_nth_hash(orfInfo.decode(), 3)
                                        ppinsidedict[
                                            "orf_start"
                                        ] = self.extract_nth_hash(orfInfo.decode(), 1)
                                        ...
                                        ppinsidedict["query_end"] = (
                                            hsp.query_start + realQueryLength
                                        )
                                    ...
                                    ppinsidedict["perc_identity"] = float(
                                        format(
                                            float(ppinsidedict["max_identities"] * 100)
                                            / len(ppinsidedict["query"]),
                                            ".2f",
                                        )
                                    )
                                    perfect[
                                        "{}|hsp_num:{}".format(hitid.decode(), init)
                                    ] = ppinsidedict
                                    init += 1
                                    ...
                                    for eachs in snpdictlist:
                                        ...
                                        if hsp.sbjct_start < int(pos) and (
                                            hsp.sbjct_start + realQueryLength
                                        ) > int(pos):
                                            ...
                                            if hsp.query[qry] == chan:
                                                ...
                                                sinsidedict["model_name"] = json_data[
                                                    modelID
                                                ]["model_name"]
                                                sinsidedict["model_type"] = json_data[
                                                    modelID
                                                ]["model_type"]
                                                sinsidedict[
                                                    "model_type_id"
                                                ...
                                                sinsidedict[
                                                    "ARO_accession"
                                                ] = json_data[modelID]["ARO_accession"]
                                                sinsidedict["ARO_name"] = json_data[
                                                    modelID
                                                ]["ARO_name"]
                                                sinsidedict["ARO_category"] = json_data[
                                                    modelID
                                                ]["ARO_category"]
                                                ...
                                                sinsidedict["cvterm_id"] = json_data[
                                                    modelID
                                                ...
                                                if (
                                                    "partial"
                                                    in json_data[modelID][
                                                        "model_sequences"
                                                    ]["sequence"][seqinModel][
                                                        "dna_sequence"
                                                    ].keys()
                                                ):
                                                    sinsidedict["partial"] = json_data[
                                                        modelID
                                                    ]["model_sequences"]["sequence"][
                                                        seqinModel
                                                    ][
                                                ...
                                                if self.input_type == "contig":
                                                    sinsidedict["query_start"] = (
                                                        self.extract_nth_hash(
                                                            orfInfo.decode(), 1
                                                        )
                                                        + (hsp.query_start - 1) * 3
                                                    )
                                                    sinsidedict["query_end"] = (
                                                        self.extract_nth_hash(
                                                            orfInfo.decode(), 1
                                                        )
                                                        + (hsp.query_start - 1) * 3
                                                ...
                                                sinsidedict["perc_identity"] = float(
                                                    format(
                                                        float(
                                                            sinsidedict[
                                                                "max_identities"
                                        ...
                                        if snp_counter == 0:
                                            ...
                                            insidedict["model_name"] = json_data[
                                                modelID
                                            ]["model_name"]
                                            insidedict["model_type"] = json_data[
                                                modelID
                                            ]["model_type"]
                                            ...
                                            insidedict["ARO_accession"] = json_data[
                                                modelID
                                            ]["ARO_accession"]
                                            insidedict["ARO_name"] = json_data[modelID][
                                                "ARO_name"
                                            ]
                                            insidedict["ARO_category"] = json_data[
                                                modelID
                                            ]["ARO_category"]
                                            ...
                                            insidedict["cvterm_id"] = json_data[
                                                modelID
                                            ]["model_sequences"]["sequence"][
                                                seqinModel
                                            ][
                                            ...
                                            if self.input_type == "contig":
                                                insidedict["query_start"] = (
                                                    self.extract_nth_hash(
                                                        orfInfo.decode(), 1
                                                    )
                                                    + (hsp.query_start - 1) * 3
                                                )
                                                insidedict["query_end"] = (
                                                    self.extract_nth_hash(
                                                        orfInfo.decode(), 1
                                                    )
                                                    + (hsp.query_start - 1) * 3
                                            ...
                                            insidedict["perc_identity"] = float(
                                                format(
                                                    float(
                                                        insidedict["max_identities"]
                                                        * 100
                                                    )
                                                    / len(insidedict["query"]),
                                                    ".2f",
                                                )
                                            )
                                            strict[
                                    ...
                                    linsidedict["model_name"] = json_data[modelID][
                                        "model_name"
                                    ]
                                    linsidedict["model_type"] = json_data[modelID][
                                        "model_type"
                                    ]
                                    ...
                                    linsidedict["ARO_accession"] = json_data[modelID][
                                        "ARO_accession"
                                    ]
                                    linsidedict["ARO_name"] = json_data[modelID][
                                        "ARO_name"
                                    ]
                                    linsidedict["ARO_category"] = json_data[modelID][
                                        "ARO_category"
                                    ]
                                    linsidedict["evalue"] = hsp.expect
                                    linsidedict["max_identities"] = hsp.identities
                                    linsidedict["bit_score"] = hsp.bits
                                    linsidedict["cvterm_id"] = json_data[modelID][
                                        "model_sequences"
                                    ]["sequence"][seqinModel]["NCBI_taxonomy"][
                                        "NCBI_taxonomy_cvterm_id"
                                    ]
                                    ...
                                    if (
                                        ...
                                        linsidedict["partial"] = json_data[modelID][
                                            "model_sequences"
                                        ]["sequence"][seqinModel]["dna_sequence"][
                                            "partial"
                                        ]
                                    ...
                                    if self.input_type == "contig":
                                        linsidedict["query_start"] = (
                                            self.extract_nth_hash(orfInfo.decode(), 1)
                                            + (hsp.query_start - 1) * 3
                                        )
                                        linsidedict["query_end"] = (
                                            self.extract_nth_hash(orfInfo.decode(), 1)
                                            + (hsp.query_start - 1) * 3
                                            + realQueryLength * 3
                                            - 1
                                    ...
                                    linsidedict["perc_identity"] = float(
                                        format(
                                            float(linsidedict["max_identities"] * 100)
                                            / len(linsidedict["query"]),
                                            ".2f",
                                        )
                                    )
                                    loose[
