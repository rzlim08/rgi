        ...
        with open(self.xml_file, "r") as result_handle:
            ...
            for blast_record in blast_records:
                ...
                for alignment in blast_record.alignments:
                    ...
                    seq_in_model = model_descrpt[
                        underscore_in_MD + 1 : model_descrpt.index(" ")
                    ]
                    ...
                    if model_type_id == 40293:
                        ...
                        for hsp in alignment.hsps:
                            ...
                            for eachs in snp_dict_list:
                                ...
                                if (
                                    hsp.sbjct_start < pos
                                    and (hsp.sbjct_start + real_sbjct_length) > pos
                                ):
                                    ...
                                    qry = (
                                        ...
                                        - hsp.sbjct_start
                                        + self.find_num_dash(
                                            hsp.sbjct, (int(pos) - hsp.sbjct_start)
                                        )
                                    )
                                    sbj = (
                                        int(pos)
                                    ...
                                    if hsp.query[qry] == chan:
                                        ...
                                        d = (
                                            ...
                                            - hsp.sbjct_start
                                            - self.find_num_dash(
                                                hsp.query, (int(pos) - hsp.sbjct_start)
                                            )
                                        )
                                        ...
                                        try:
                                            if float(hsp.bits) >= float(
                                                ...
                                                sinsidedict[
                                                    "ARO_accession"
                                                ] = json_data[model_id]["ARO_accession"]
                                                ...
                                                if (
                                                    "partial"
                                                    in json_data[model_id][
                                                        "model_sequences"
                                                    ]["sequence"][seq_in_model][
                                                        "dna_sequence"
                                                    ].keys()
                                                ):
                                                ...
                                                slinsidedict["model_name"] = json_data[
                                                    model_id
                                                ]["model_name"]
                                                slinsidedict["model_type"] = json_data[
                                                    model_id
                                                ]["model_type"]
                                                slinsidedict[
                                                    "model_type_id"
                                                ...
                                                slinsidedict["ARO_name"] = json_data[
                                                    model_id
                                                ]["ARO_name"]
                                                slinsidedict[
                                                    "ARO_category"
                                                ] = json_data[model_id]["ARO_category"]
                                                slinsidedict["evalue"] = hsp.expect
                                                slinsidedict["bit_score"] = hsp.bits
                                                slinsidedict[
                                                    "max_identities"
                                                ] = hsp.identities
                                                slinsidedict["cvterm_id"] = json_data[
                                                    model_id
                                                ]["model_sequences"]["sequence"][
                                                    seq_in_model
                                                ][
                                                ...
                                                if (
                                                    ...
                                                    slinsidedict["partial"] = json_data[
                                                        model_id
                                                    ]["model_sequences"]["sequence"][
                                                        seq_in_model
                                                    ][
                                                ...
                                                if self.input_type == "contig":
                                                    slinsidedict["query_start"] = (
                                                        self.extract_nth_hash(
                                                            orf_info.decode(), 1
                                                        )
                                                        + (hsp.query_start - 1) * 3
                                                    )
                                                    slinsidedict["query_end"] = (
                                                        self.extract_nth_hash(
                                                            orf_info.decode(), 1
                                                        )
                                                        + (hsp.query_start - 1) * 3
                                                ...
                                                slinsidedict["perc_identity"] = float(
                                                    format(
                                                        float(
                                                            slinsidedict[
                                                                "max_identities"
                                            ...
                                            logger.warning(
                                                "{} ---> hsp.bits: {} {} ? {}".format(
                                                    json_data[model_id]["model_name"],
                                                    hsp.bits,
                                                    type(hsp.bits),
                                                    type(true_pass_evalue),
                                                )
                                            )
