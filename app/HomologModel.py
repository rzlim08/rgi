                    ...
                    if modelTypeID == 40292:
                        ...
                        for hsp in alignment.hsps:
                            ...
                            if predicted_genes_dict_protein:
                                if (
                                    orfInfo.strip()
                                    in predicted_genes_dict_protein.keys()
                                ):
                                    orf_protein_sequence = predicted_genes_dict_protein[
                                        orfInfo.decode()
                                    ].strip("*")
                                else:
                                    orf_protein_sequence = predicted_genes_dict_protein[
                            ...
                            try:
                                if (
                                    ...
                                    insidedict["model_name"] = json_data[modelID][
                                        "model_name"
                                    ]
                                    insidedict["model_type"] = json_data[modelID][
                                        "model_type"
                                    ]
                                    ...
                                    insidedict["sequence_from_broadstreet"] = json_data[
                                        modelID
                                    ]["model_sequences"]["sequence"][seqinModel][
                                        "protein_sequence"
                                    ][
                                        "sequence"
                                    ]
                                    ...
                                    if (
                                        ...
                                        insidedict["partial"] = json_data[modelID][
                                            "model_sequences"
                                        ]["sequence"][seqinModel]["dna_sequence"][
                                            "partial"
                                        ]
                                    ...
                                    insidedict["perc_identity"] = float(
                                        format(
                                            float(insidedict["max_identities"] * 100)
