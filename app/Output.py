                    ...
                    for it in data[item]:
                        ...
                        if self.checkKeyExisted("ARO_category", data[item][it]):
                            for aroctkey in data[item][it]["ARO_category"]:
                                ...
                                cgList.append(
                                    str(
                                        data[item][it]["ARO_category"][aroctkey][
                                            "category_aro_name"
                        ...
                        if data[item][it]["model_type_id"] == 40293:
                            temp = (
                                data[item][it]["SNP"]["original"]
                                + str(data[item][it]["SNP"]["position"])
                        ...
                        AROlist.append(
                            str(
                                data[item][it]["ARO_accession"].encode(
                                    "ascii", "replace"
                                ),
                                "utf-8",
                            )
                        ...
                        AROnameList.append(
                            str(
                                data[item][it]["ARO_name"].encode("ascii", "replace"),
                                "utf-8",
                            )
                        )
                        ...
                        if startCompare:
                            if maxscore < float(
                                data[item][it]["bit-score"]
                            ) and maxpercent < float(data[item][it]["perc_identity"]):
                                ...
                                SequenceFromBroadStreet = data[item][it][
                                    "sequence_from_broadstreet"
                                ]

                                if "orf_prot_sequence" in data[item][it]:
                                    predictedProtein = data[item][it][
                                        "orf_prot_sequence"
                                    ]
                                ...
                                if self.checkKeyExisted("ARO_category", data[item][it]):
                                    for key in data[item][it]["ARO_category"]:
                                        bestAROcategory.append(
                                            str(
                                                data[item][it]["ARO_category"][key][
                                                    "category_aro_name"
                                                ].encode("ascii", "replace"),
                                                "utf-8",
                                            )
