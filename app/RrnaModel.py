            ...
            for blast_record in blast_records:
                ...
                for alignment in blast_record.alignments:
                    ...
                    if model_type_id == 40295:
                        ...
                        for hsp in alignment.hsps:
                            ...
                            for eachs in snp_dict_list:
                                ...
                                if (
                                    hsp.query_start < pos
                                    and (hsp.query_start + real_query_length) > pos
                                ):
                                    ...
                                    qry = (
                                        ...
                                        - hsp.query_start
                                        + self.find_num_dash(
                                            hsp.query, (int(pos) - hsp.query_start)
                                        )
                                    )
                                    sbj = (
                                        int(pos)
                                    ...
                                    if hsp.sbjct[sbj] == chan:
                                        ...
                                        if strand == "+":
                                            d = (
                                                ...
                                                - self.find_num_dash(
                                                    hsp.sbjct,
                                                    (int(pos) - hsp.query_start),
                                                )
                                            )
                                            # d = -1*(hsp.query_start - pos)
                                            query_snps = {
                                                "original": hsp.query[d],
                                                "change": hsp.sbjct[d],
                                                "position": (d + 1),
                                            }
                                        else:
                                        ...
                                        logger.info(
                                            "position in the query (3'->5') : {}".format(
                                                d
                                            )
                                        )
                                        ...
                                        try:
                                            if float(hsp.bits) >= float(
                                                ...
                                                sinsidedict[
                                                    "_orf_strand"
                                                ] = self.extract_nth_bar(orf_info, 0)
                                                sinsidedict[
                                                    "_orf_start"
                                                ] = self.extract_nth_bar(orf_info, 1)
                                                sinsidedict[
                                                    "_orf_end"
                                                ] = self.extract_nth_bar(orf_info, 2)
                    ...
                    blastResults = self.results(
                        blastResults,
                        blast_record.query + " | QUERY: " + alignment.hit_def,
                        perfect,
                        strict,
                        loose,
                        self.include_nudge,
